...
const RejectedNFTSCardDashboard = ({
  path,
  userId,
}) => {
  ...
  const{  getProviderNFTContrat, checkIsWalletConnected, account, getSignerMarketContrat } = useContext(Store); 
...
export default RejectedNFTSCardDashboard;
