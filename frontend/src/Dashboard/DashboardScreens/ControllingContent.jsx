...
function ControllingContent({ search, setSearch }) {
    ...
    const getSelectedId = (id) => {
        ...
        if (selectedNTFIds.includes(id)) {
            setSelectedNTFIds(selectedNTFIds.filter(selectedId => selectedId !== id));
        ...
        <div className="user-management">
            ...
            <div className="user-management-after-header">
                <div className="dashboard-front-section-2">
                    ...
                    <div className="nft-card-btn-holder" style={{justifyContent:' end' , gap : '10px', marginTop : '20px'}}>
                        <button>Decline</button>
                        <button>Accept</button>
                    </div>
                    }
                </div>
                <div className="table-for-user-management" style={{top : selectedNTFIds.length > 0 ? '160px' : '120px'}}>
                    {list?.data?.length > 0 ?
                        <>
                            <div className="row">
                            ...
                            <div className="user-management-table-contorls" style={{ justifyContent: 'center' }}>
                                <button className={`controling-Nft-Load-More ${list?.pagination?.remaining == 0 ? "disable" : ""}`}
                                    onClick={() => {
                                        viewNftList(
