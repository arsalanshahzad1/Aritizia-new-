              ...
              <div className="row">
                <ul>
                  ...
                  >
                    <button
                      className={`${
                        activeTabs === "Notification" ? "active" : ""
                      }`}
                    >
                      <ImNotification />
                      Notification
                  ...
                  <li
                    onClick={() => {
                      setActiveTabs("Earnings");
                    }}
                  >
                    <button
                      className={`${activeTabs === "Earnings" ? "active" : ""}`}
                    >
                      <FaHandHoldingUsd />
                      Earnings
                    </button>{" "}
                  ...
                  <li
                    onClick={() => {
                      setActiveTabs("Purchase");
                    }}
                  >
                    <button
                      className={`${activeTabs === "Purchase" ? "active" : ""}`}
                    >
                      <FaHandHoldingUsd />
                      Purchase
                    </button>{" "}
                  ...
                  >
                    <button
                      className={`${activeTabs === "Edit" ? "active" : ""}`}
                    >
                      <FaEdit />
                      Edit
                    </button>
