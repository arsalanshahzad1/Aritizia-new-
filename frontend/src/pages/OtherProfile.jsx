        ...
        <div className="profile-first-section">
          ...
          <div className="detail">
            <div className="container-fluid">
              <div className="row">
                <div
                  className="col-lg-4 col-md-4 col-12 followers-div"
                  id="hide-on-mobile"
                >
                  {userData?.email !== null ? (
                    <>
                ...
                <div
                  className="col-lg-4 col-md-4 col-6 my-auto"
                  id="hide-on-mobile"
                    ...
                    }
{
              ...
              <div className="row">
                <div
                  className="col-lg-4 col-md-4 col-12 followers-div justify-content-center"
                  id="hide-on-desktop"
                >
                  {userData?.email !== null ? (
                    <>
              ...
              <div className="row mt-2">
                <div
                  className="col-lg-3 col-md-3 col-6 my-auto"
                  id="hide-on-desktop"
                >
                  {userData?.email !== null ? (
                    <>
                ...
                <div
                  className="col-lg-4 col-md-4 col-6 justify-content-center"
                  id="hide-on-desktop"
                >
                  <div className="other-user-icons">
...

{
              ...
              <div className="row">
                ...
                <div
                  className="col-lg-3 col-md-3 col-12 my-auto"
                  id="hide-on-mobile"
                  style={{ justifyContent: "end" }}
                >
                  {userData?.email !== null ? (
