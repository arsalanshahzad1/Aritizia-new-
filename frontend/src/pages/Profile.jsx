...
const Profile = ({ search, setSearch }) => {
  ...
  const [userAddress, setUserAddress] = useState("0x000000000000....");
  ...
  const initialCheckboxData = [
    { id: 1, label: 'Checkbox 1', checked: false, FollowerName: "Monica Lucas", FollowersCount: "100k", FollowerImg: followerImg },
    { id: 2, label: 'Checkbox 2', checked: false, FollowerName: "Monica Lucas", FollowersCount: "100k", FollowerImg: followerImg },
    { id: 3, label: 'Checkbox 3', checked: false, FollowerName: "Monica Lucas", FollowersCount: "100k", FollowerImg: followerImg },
    { id: 4, label: 'Checkbox 4', checked: false, FollowerName: "Monica Lucas", FollowersCount: "100k", FollowerImg: followerImg },
    { id: 5, label: 'Checkbox 5', checked: false, FollowerName: "Monica Lucas", FollowersCount: "100k", FollowerImg: followerImg },
    { id: 6, label: 'Checkbox 6', checked: false, FollowerName: "Monica Lucas", FollowersCount: "100k", FollowerImg: followerImg },
    { id: 7, label: 'Checkbox 7', checked: false, FollowerName: "Monica Lucas", FollowersCount: "100k", FollowerImg: followerImg },
