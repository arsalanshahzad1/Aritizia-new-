              ...
              <div className="left">
                {path === "/" ? (
                  ...
                  <>
                    ...
                    <span className="icon-for-header">
                      <svg width="36" height="26" viewBox="0 0 46 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="icon-for-header">
                      <svg width="24" height="30" viewBox="0 0 29 38" fill="none" xmlns="http://www.w3.org/2000/svg">
