                ...
                <div className="logo">
                  <Link to={"/"} style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                    ...
                    {scrolled ?
                      ...
                      :
                      (<div><img src="/assets/logo/logo-title-light.png" alt="" /></div>)
                    }
                  </Link>
                </div>
              ) : (
              ...
              <div className="left">
                {path === "/" ? (
                  <>
                    ...
                    {user &&
                      <span onClick={() => { setshowMessage(!showMessage), setShowNotification(false), getChatnotification('message', 0) }} className={`icon-for-header ${scrolled ? 'black-svgs' : ""}`}>
                        <svg width="36" height="26" viewBox="0 0 46 32" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
                          ...
                          {messageArrive && <circle cx="39.834" cy="5.5" r="5.5" fill="#2636D9" />}
                        </svg>
                      </span >}
                    {showMessage &&
                      <div className="notification-card">
                        <>
                          {chatNotificationRes ?
                            <Notification data={chatNotificationRes} link={'/chat'} image={NotificationIcon} name={'FAHAD'} desc={'sent you message'} msg={'Hi this is fahad....'} />
                            :
                          ...
                          {(chatNotificationRes.length < countLength && chatNotificationRes) ?
                            <button className="loadmore-mgs-notofication" onClick={() => getChatnotification('loadmore', chatNotificationRes.length)}>load more</button>
                            :
                            null
                          }
                        </>
                    ...
                    <button
                      ...
                      style={{ margin: user ? '0px 20px 0px 15px' : '0px 0px 0px 3px' }}
                    >
                      {user ?
                        'Connected'
                        :
                  ...
                  <>
                    ...
                    {user &&
                    <span className="icon-for-header">
                      <svg onClick={() => { setshowMessage(!showMessage), setShowNotification(false), getChatnotification('message', 0) }} width="36" height="26" viewBox="0 0 46 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {showMessage &&
                      <div className="notification-card" style={{left : '38%'}}>
                        <>
                          {chatNotificationRes ?
                            <Notification data={chatNotificationRes} link={'/chat'} image={NotificationIcon} name={'FAHAD'} desc={'sent you message'} msg={'Hi this is fahad....'} />
                            :
